...
export default async function ExternalNotificationsPage({
  searchParams,
}: {
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Avisos dos eventos da sua empresa no portal. O registro oficial continua sendo a própria
          tela do cadastro, documento, qualificação, fiscalização ou não conformidade (RN-022).
        </p>
      </div>
      <NotificationList
        items={items}
        ...
        basePath="/portal-fornecedor/notificacoes"
      />
    </div>
  );
}
